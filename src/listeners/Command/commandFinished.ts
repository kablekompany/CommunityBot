import type { Args, Command, CommandFinishPayload, Events, ListenerOptions } from '@sapphire/framework';
...
export default class extends Listener<typeof Events.CommandFinish> {
	public async run(message: Message, command: Command, payload: CommandFinishPayload<Args>) {
